    ...
    <ClientOnly>
      <template #fallback>
        <NapkinbetsDashboardSkeleton>
          <template #sr-label>Pulling your bets and invitations.</template>
        </NapkinbetsDashboardSkeleton>
      </template>
      ...
      <div class="napkinbets-dashboard-content">
        ...
        <NapkinbetsDashboardSkeleton v-else-if="isInitialWorkspaceLoad">
          <template #sr-label>Pulling your bets, invitations, and settlements. Loading your bets.</template>
        </NapkinbetsDashboardSkeleton>
