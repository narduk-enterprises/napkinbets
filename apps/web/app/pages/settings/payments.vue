...
useSeo({
  ...
  description:
    'Register your Venmo, PayPal, Cash App, or Zelle handles so Napkinbets can prefill napkin collection and settle-up flows.',
  ogImage: {
    ...
    <div class="napkinbets-hero">
      <div class="space-y-4">
        ...
        <h1 class="napkinbets-section-title">
          Saved handles for smoother napkin collection and settle-up.
        </h1>
          ...
          <UForm :state="formState" class="space-y-4" @submit.prevent="handleSave">
            ...
            <div class="space-y-3">
              ...
              <UCheckbox
                ...
                label="Show this handle on shared napkin views"
              />
            </div>
      ...
      <UCard class="napkinbets-panel">
        <div class="space-y-4">
          ...
          <UAlert
            ...
            description="Add at least one payment identity so napkin creation and settle-up can prefill the right destination."
          />
        </div>
      </UCard>
    </div>
