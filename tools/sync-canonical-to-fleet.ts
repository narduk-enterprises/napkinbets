 ...
 *
 * Keeps `napkinbets` (Level 1 Fleet Hub) in sync with
 * `0_global-canonical-tokens` (Level 0 Canonical Hub).
 *
 * Because Doppler blocks daisy-chaining references, napkinbets
 ...
 * into napkinbets's dev and prd configs.
 *
 * Usage:
...
console.log(
  DRY_RUN
    ...
    : '🚀 APPLYING changes to napkinbets...\n',
)
