...
const HUB_KEYS: Record<string, string> = {
  CLOUDFLARE_API_TOKEN: 'napkinbets',
  CLOUDFLARE_ACCOUNT_ID: 'napkinbets',
...
function main() {
  ...
  console.log('         hub=all hub keys are cross-refs to napkinbets / narduk-analytics')
  console.log()
}
